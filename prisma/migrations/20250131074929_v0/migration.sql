...
CREATE TABLE "Offer" (
    ...
    "contactEmail" TEXT,
    "location" TEXT,
    "publised" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Offer" ADD CONSTRAINT "Offer_idCategtory_fkey" FOREIGN KEY ("idCategtory") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
